...
public class MolzenCrop extends CropsBlock {
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        BiomeTemperature temp = BiomeTemperature.toEnum(context.getLevel().getBiome(context.getClickedPos()).getBiomeCategory());
        if(temp == inValidBiome) {return null;}
