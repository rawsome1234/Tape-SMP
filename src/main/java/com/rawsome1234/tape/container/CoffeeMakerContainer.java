...
public class CoffeeMakerContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity player;
    private final IItemHandler playerInventory;

    public CoffeeMakerContainer(int windowID, World world, BlockPos pos,
    ...
    private CompoundNBT getCoffeeTileData(){
        return tileEntity.getTileData();
    }

    public int getBottles(){
        if(getCoffeeTileData().contains("water")){
            return getCoffeeTileData().getInt("water");
        }
        else{
            return -1;
        }
    ...
    public int getMaxBottles(){
        if(getCoffeeTileData().contains("maxWater")){
            return getCoffeeTileData().getInt("maxWater");
        }
        else{
            return -1;
        }
    ...
    public int getRemainingTicks(){
        if(getCoffeeTileData().contains("ticksRemaining")){
//            System.out.println(getCoffeeTileData().getInt("ticksRemaining"));
            return getCoffeeTileData().getInt("ticksRemaining");
        }
        else{
            return -1;
        }
    ...
    public int getTotalTicks(){
        if(getCoffeeTileData().contains("totalTicks")){
//            System.out.println(getCoffeeTileData().getInt("totalTicks"));
            return getCoffeeTileData().getInt("totalTicks");
        }
        else{
            return -1;
        }
